...
/**
 * A Spinner view that does not dismiss the dialog displayed when the control is "dropped down" and the user presses it. This allows for the selection of more
 * than one option.
 */
public class MultiSelectSpinner extends Spinner implements OnMultiChoiceClickListener {
	 ...
	 * @param context
	 */
	public MultiSelectSpinner(Context context, String plural) {
		super(context);
		this.plural = plural;
	 ...
	 * 
	 * @return If one item is selected, that item, otherwise how many items are selected.
	 */
	private String buildSelectedItemString() {
		...
		return count == 1 ? selection : "(" + count + " " + plural + ")";
	}
}